  ...
  return (
    <div className="w-full max-w-sm mx-auto bg-white overflow-hidden">
      <div className="relative w-full h-[250px] flex">
        ...
        <div className="flex items-center bg-white rounded-full shadow-sm border border-gray-200 overflow-hidden w-[300px]">
        <div className="flex items-center flex-1 px-3 py-2">
            <MagnifyingGlassIcon className="w-4 h-4 text-gray-400 mr-2" />
            <input
            type="text"
            placeholder="Search destinations..."
            className="flex-1 min-w-0 text-xs text-gray-600 placeholder-gray-400 border-none outline-none bg-transparent"
            />
        </div>
        ...
        <button
            onClick={handleNext}
            disabled={isAnimating}
            className="bg-blue-500 hover:bg-blue-600 text-white p-2 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-lg disabled:opacity-70 disabled:cursor-not-allowed group"
        >
            <ChevronRightIcon className="w-4 h-4 transition-transform duration-300 group-hover:translate-x-0.5" />
        </button>
        </div>
        ...
        <div className="relative w-[49%] h-[250px] overflow-hidden">
          <div 
        ...
        <div className="absolute right-0 top-0 w-16 h-full z-20">
          <button
            ...
            disabled={isAnimating}
            className="w-full h-[250px] relative overflow-hidden group disabled:cursor-not-allowed"
          >
            <div 
              className={`absolute inset-0 transition-all duration-500 ease-in-out ${
                isAnimating ? '-translate-x-full opacity-0' : 'translate-x-0 opacity-100'
            ...
            >
              <img
                ...
                alt="Next"
                className="w-full h-[250px] object-cover rounded-lg object-left transition-transform duration-300 group-hover:scale-105"
              />
