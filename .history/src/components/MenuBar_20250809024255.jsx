...
const MenuBar = () => {
  ...
  return (
    // <nav className="flex justify-center items-center py-3 px-3 bg-white min-h-[75px]">
    //   <div className="flex flex-nowrap items-center justify-center bg-[#F5F5F5] border-2 border-[#F5F5F5] rounded-[100px] px-3 py-3 shadow-md hover:shadow-lg transition-all duration-300 gap-0">
  ...
  <div className="flex flex-nowrap items-center justify-center bg-[#F5F5F5] border-2 border-[#F5F5F5] rounded-[100px] px-3 py-3 shadow-md hover:shadow-lg transition-all duration-300 gap-0 max-w-[400px]">
        {menuItems.map((item, index) => (
          <div
            key={index}
            className={`
              relative cursor-pointer transition-all duration-300 ease-in-out px-2 md:px-3 py-2 md:py-3 rounded-xl select-none text-center whitespace-nowrap
