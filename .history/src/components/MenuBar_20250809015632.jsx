...
const MenuBar = () => {
  ...
  return (
    <nav className="flex justify-center items-center p-4 md:p-6 bg-white min-h-[80px] md:min-h-[100px]">
      <div className="flex flex-nowrap md:flex-nowrap items-center justify-center bg-[#F5F5F5] border-2 border-[#F5F5F5] rounded-[20px] px-6 md:px-10 py-6 md:py-8 shadow-md hover:shadow-lg transition-all duration-300 gap-4 md:gap-8 lg:gap-8 max-w-4xl">
        {menuItems.map((item, index) => (
          <div
            key={index}
            className={`
