...
const MenuBar = () => {
  ...
  return (
    <nav className="flex justify-center items-center p-4 md:p-6 bg-white min-h-[50px] md:min-h-[100px]">
      ...
      <div className="grid grid-cols-5 bg-[#F5F5F5] border-2 border-[#F5F5F5] rounded-[100px] shadow-md hover:shadow-lg transition-shadow duration-300 w-[500px] sm:w-[500px] md:w-[500px] lg:w-[600px] xl:w-[700px]">  
        {menuItems.map((item, index) => (
          <div
            key={index}
            className={`
