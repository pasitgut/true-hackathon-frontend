...
const ImageSlider = () => {
  ...
  return (
    <div className="w-full max-w-sm mx-200px bg-white overflow-hidden">
      <div className="relative w-full h-[200px] flex">
        
        {/* ส่วนที่ 1: Content Section (ซ้าย) */}
        <div className="relative z-30 w-1/2 bg-gradient-to-br from-slate-50 to-slate-100 p-6 flex flex-col justify-between">
