...
const MenuBar = () => {
  ...
  return (
    <nav className="flex justify-center items-center p-4 md:p-6 bg-white min-h-[50px] md:min-h-[100px]">
      <div className="flex flex-nowrap md:flex-nowrap items-center justify-center bg-[#F5F5F5] border-2 border-[#F5F5F5] rounded-[100px] px-6 md:px-6 py-3 md:py-6  shadow-md hover:shadow-lg transition-all duration-300 gap-0 ">
