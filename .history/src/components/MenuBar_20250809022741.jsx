...
const MenuBar = () => {
  ...
  return (
    <nav className="flex justify-center items-center p-4 md:p-6 bg-white min-h-[50px] md:min-h-[100px]">
      ...
      <div className="grid grid-cols-5 bg-[#F5F5F5] border-2 border-[#F5F5F5] rounded-[100px] shadow-md hover:shadow-lg transition-shadow duration-300 w-[400px] sm:w-[400px] md:w-[400px] lg:w-[400px] xl:w-[400px]">  
        {menuItems.map((item, index) => (
          <div
            key={index}
            className={`
