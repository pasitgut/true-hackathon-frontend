  ...
  return (
    <div className="w-full max-w-sm mx-auto bg-white overflow-hidden">
      <div className="relative w-full h-[200px] flex">
        ...
        <div className="relative w-[49%] h-[200px] overflow-hidden">
          <div 
        ...
        <div className="absolute right-0 top-0 w-16 h-full z-20">
          <button
            ...
            className="w-full h-[200px] relative overflow-hidden group disabled:cursor-not-allowed"
          >
            <div 
              className={`absolute inset-0 transition-all duration-500 ease-in-out ${
                isAnimating ? '-translate-x-full opacity-0' : 'translate-x-0 opacity-100'
            ...
            >
              <img
                ...
                alt="Next"
                className="w-full h-[200px] object-cover rounded-lg object-left transition-transform duration-300 group-hover:scale-105 group-hover:object-cover rounded-lg"
              />
            </div>
